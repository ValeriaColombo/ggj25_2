...
public class SpriteAnimator : MonoBehaviour {
    ...
    [SerializeField] private Animator frente;
    [SerializeField] private Transform frenteTransf;
    [SerializeField] private Animator perfil;
    [SerializeField] private bool isAlive;

    private Quaternion noRotation = Quaternion.Euler(0, 0, 0);
    private Quaternion sideRotation = Quaternion.Euler(0, 0, -45);

    public void AnimateInternalCharacterIdle()
    {
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterRun()
    {
        perfil.Play("Alive_perfil_walk");
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterWall()
    {
        perfil.Play("Alive_perfil_wall");
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterSideJumpSube()
    {
        perfil.Play("Alive_perfil_salto_sube");
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterStraightJumpSube()
    {
        frente.Play("Alive_frente_salto_sube");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterStraightFall()
    {
        frente.Play("Alive_frente_caida");
        frenteTransf.rotation = isAlive ? sideRotation : noRotation;
    }

    public void AnimateInternalCharacterDangling()
    {
        frente.Play("Alive_frente_caida");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterSideJumpVuela()
    {
        perfil.Play("Alive_perfil_cayendo");
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }

    public void AnimateInternalCharacterSideJumpBaja()
    {
        perfil.Play("Alive_perfil_salto_baja");
        frente.Play("Alive_frente_idle");
        frenteTransf.rotation = noRotation;
    }
}
